...
<img src="https://github.com/jlcareglio.png?size=256" />

<div>
  jlcareglioalbornoz@gmail.com <br>
  tel: +54 266-4843722 <br>
  Nacionalidad: Argentina 🇦🇷 <br>
  <a href="https://github.com/jlcareglio" target="_blank">GitHub</a> | 
  <a href="https://linkedin.com/in/jlcareglio" target="_blank">LinkedIn</a> <br>
...
* Trabajé más de 2 años como Game Developer especializado en Unity3D Programmer
* Conocimientos en metodologías ágiles, GIT, estructura de datos, algoritmos, frameworks
* Experiencia en gestión de proyectos, desarrollo de Front End y Back End
...
* Otras habilidades: Terminal Linux, Mobile Development, Firebase, Vercel, Testing, Scrum, REST, Figma, Three.js, Data Scraping, GameEngines: Unity3D, Unreal & Godot, AI, MPC (Model Context Protocol) & NLWeb (Natural Language Web)
...
* Programa 111 Mil - Analista del Conocimiento Trayecto Programador (2017)
